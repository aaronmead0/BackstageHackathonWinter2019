...
namespace Calculator
{
    ...
    internal class Calculator : Actor, ICalculator
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> ICalculator.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task ICalculator.SetCountAsync(int count, CancellationToken cancellationToken)
        {
      ...
      public  Task<int> AddIntegersAsync(int one, int two, CancellationToken cancellationToken)
        {
            int sum = Add(one, two);
